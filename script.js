...
const I18N = {
  de: {
    ...
    'hero.lede': 'Noch keine KI-Abteilung, aber Sie brauchen KI, die funktioniert und im Einklang mit der EU-KI-Verordnung bleibt. Ich baue sie von Grund auf auf, passend zu Ihrer Phase.',
    ...
    'ready.lede': 'Die zentralen Pflichten gelten ab August 2026. Klein zu sein ist keine Ausnahme. Es früh richtig zu machen ist günstiger als spätes Nachrüsten und schafft Vertrauen bei großen Kunden und Investoren.',
    ...
    'needs.lede': 'Data Scientist, Compliance, Architektur: kleine Teams haben meist niemanden davon. Bei mir bekommen Sie eine Person, die alle drei Rollen abdeckt.',
    ...
    'about.lede': 'Ich denke Modell, Architektur und Regulierung zusammen. KI habe ich in zwei der am stärksten regulierten Bereiche in den Einsatz gebracht: sicherheitskritische Industrie und Gesundheit.',
    'about.bio': 'Gründerin von Pruna Secura. Früher Enterprise-Architektin in sicherheitskritischer Bahntechnik, davor Wissenschaftlerin im MedTech-Bereich. Heute helfe ich Start-ups, ihre IT von Grund auf aufzubauen, rund um die KPIs, die zählen.',
